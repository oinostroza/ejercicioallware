...
public class Contrato_ServiceLocator extends org.apache.axis.client.Service implements org.example.www.Contrato.Contrato_Service {
    ...
    private java.lang.String ContratoSOAP_address = "http://localhost:8088/CrearContrato/services/ContratoSOAP";
    ...
    public org.example.www.Contrato.Contrato_PortType getContratoSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public org.example.www.Contrato.Contrato_PortType getContratoSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.example.www.Contrato.ContratoSOAPStub _stub = new org.example.www.Contrato.ContratoSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.example.www.Contrato.Contrato_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.example.www.Contrato.ContratoSOAPStub _stub = new org.example.www.Contrato.ContratoSOAPStub(new java.net.URL(ContratoSOAP_address), this);
                _stub.setPortName(getContratoSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.example.org/Contrato/", "Contrato");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.example.org/Contrato/", "ContratoSOAP"));
        }
